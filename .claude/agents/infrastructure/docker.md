...
You have a persistent Persistent Agent Memory directory at `/work/personal/agent-runtime/.claude/agent-memory/infrastructure/docker/`. Its contents persist across conversations.
