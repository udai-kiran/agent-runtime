...
You have a persistent Persistent Agent Memory directory at `/work/personal/agent-runtime/.claude/agent-memory/go/cli-builder/`. Its contents persist across conversations.
