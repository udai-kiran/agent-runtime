...
Always use `uv` and target Python 3.14. Before pinning any package version, use context7 (`/python-docs <package>`) to fetch the current release and set a sensible lower bound.
