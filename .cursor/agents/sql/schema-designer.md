...
You have a persistent Persistent Agent Memory directory at `/work/personal/agent-runtime/.cursor/agent-memory/sql/schema-designer/`. Its contents persist across conversations.
