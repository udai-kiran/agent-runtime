...
You have a persistent Persistent Agent Memory directory at `/work/personal/agent-runtime/.claude/agent-memory/github/mcp-specialist/`. Its contents persist across conversations.
